...
const HomeSection = () => {
  return (
    <section className="section home-section" id="home">
      <div className="hero">
        <img src="https://github.com/VladislavFront/FrontendPortfolio/blob/main/img/hero.png?raw=true" alt="фотография разработчика" className="hero__img" width="350px" height="650px"/>
      </div>
